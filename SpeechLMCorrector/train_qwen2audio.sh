#!/bin/bash
# Qwen2-Audio LoRA Fine-tuning Script
# Usage:
#   ./train.sh                          # Single GPU
...
CONFIG="training_config_qwen2audio.yaml"
NUM_GPUS=1
ADAPTER=""
OUTPUT_DIR=""
PORT=29500
...
echo "=== Qwen2-Audio LoRA Training ==="
...
if [ "$NUM_GPUS" -gt 1 ]; then
    ...
    torchrun --nproc_per_node=$NUM_GPUS --master_port=$PORT training_qwen2audio.py $ARGS
else
    python training_qwen2audio.py $ARGS
fi
